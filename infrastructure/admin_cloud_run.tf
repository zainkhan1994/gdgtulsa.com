...
resource "google_cloud_run_v2_service" "admin" {
  ...
  template {
    ...
    containers {
      image = "us-central1-docker.pkg.dev/gdg-tulsa/cloud-run-source-deploy/gdg-tulsa-admin@sha256:1b2b81260aa3e2c081ef5fdfc6c1ece7c545304e1d3f250003de19f868d2b0dd"
