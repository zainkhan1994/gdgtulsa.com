...
resource "google_cloud_run_v2_service" "admin" {
  ...
  template {
    ...
    containers {
      image = "us-central1-docker.pkg.dev/gdg-tulsa/cloud-run-source-deploy/gdg-tulsa-admin@sha256:68cf9e685adc4eb2dd5186f7c3d580333e6d5266688f973ab87a79df5eb86d46"
