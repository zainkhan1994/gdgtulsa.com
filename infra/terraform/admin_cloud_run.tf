...
resource "google_cloud_run_v2_service" "admin" {
  ...
  template {
    ...
    containers {
      image = "us-central1-docker.pkg.dev/gdg-tulsa/cloud-run-source-deploy/gdg-tulsa-admin@sha256:7e4cfcb3f380b547015caec2fa122929b05796d2ac1a15b9a0eed3da5836a454"
